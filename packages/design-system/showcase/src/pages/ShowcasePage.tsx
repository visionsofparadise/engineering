...
import { ButtonSelection } from "../components/controls/ButtonSelection";
...
const LOUDNESS_VIRIDIS = [
  { token: "waveform", hex: "#F0F0F8", label: "Waveform" },
  { token: "lufs", hex: "#FB923C", label: "LUFS" },
  { token: "rms", hex: "#F0ABFC", label: "RMS" },
  { token: "peak", hex: "#F87171", label: "Peak" },
] as const;
...
const VIRIDIS_POINTS: ReadonlyArray<readonly [number, number, number]> = [
  [68, 1, 84], [72, 35, 116], [64, 68, 135], [52, 96, 141],
  [33, 137, 136], [26, 158, 123], [42, 182, 91], [118, 191, 47],
  [168, 186, 35], [208, 200, 29], [240, 218, 28], [253, 231, 37],
];

function colormapGradient(points: ReadonlyArray<readonly [number, number, number]>): string {
      ...
      <Section label="Colormaps">
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-1">
            ...
            <div className="relative h-8" style={{ background: colormapGradient(LAVA_POINTS) }}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative h-8" style={{ background: colormapGradient(VIRIDIS_POINTS) }}>
              <div className="absolute inset-0 flex items-center justify-around px-4">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <button type="button" className="bg-primary font-technical text-[length:var(--text-sm)] uppercase tracking-[0.06em] text-void transition-colors hover:brightness-110">
                Export
              </button>
              <button type="button" className="bg-secondary font-technical text-[length:var(--text-sm)] uppercase tracking-[0.06em] text-chrome-text transition-colors hover:brightness-125">
                Render
              </button>
              <button type="button" className="font-technical text-[length:var(--text-sm)] uppercase tracking-[0.06em] text-chrome-text-secondary transition-colors hover:text-chrome-text">
                Cancel
              </button>
              <button type="button" className="font-technical text-[length:var(--text-sm)] uppercase tracking-[0.06em] text-chrome-text-dim cursor-not-allowed" disabled>
                Disabled
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                <label className="font-technical text-[length:var(--text-xs)] uppercase tracking-[0.08em] text-chrome-text-secondary">Text</label>
                <input
                  type="text"
                  placeholder="Enter value…"
                  className="bg-void px-2 py-1.5 font-body text-[length:var(--text-sm)] text-chrome-text outline-none placeholder:text-chrome-text-dim focus:ring-1 focus:ring-secondary"
                />
              </div>
              <div className="flex flex-col gap-1">
                <label className="font-technical text-[length:var(--text-xs)] uppercase tracking-[0.08em] text-chrome-text-secondary">Number</label>
                <input
                  type="text"
                  defaultValue="-24.5"
                  className="bg-void px-2 py-1.5 font-technical text-[length:var(--text-sm)] tabular-nums text-chrome-text outline-none focus:ring-1 focus:ring-secondary"
                />
              </div>
              <div className="flex flex-col gap-1">
